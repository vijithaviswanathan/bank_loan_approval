...
- 📈 Random Forest achieved a **0.904 ROC-AUC**, showing strong classification capability.
- 📊 Log transformations helped reduce the skewness of important financial features.
- ⚖️ Class balancing provided a more balanced representation of loan approval outcomes during training.
- 🧠 The tested deep-learning models did not outperform Random Forest on this relatively small tabular dataset.
- 💡 The project demonstrated that **model suitability can be more important than model complexity** when working with structured tabular data.

---

## 📂 Output Folders

The project stores generated outputs in the following directories:
